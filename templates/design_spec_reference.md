...
> Use 1-2 sentences of natural language to describe the overall feeling this presentation should evoke in the audience. This serves as an "emotional anchor" for the Executor during per-page generation.

**Mood**: [Fill in — e.g., "Like flipping through a Bloomberg Businessweek data special — cool, authoritative, letting the data speak." or "A warm fireside conversation with clean visuals and generous whitespace."]

> If a design philosophy was selected (see `references/design-philosophies.md`), incorporate its Visual DNA here.
