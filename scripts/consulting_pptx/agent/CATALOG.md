...
This catalog enumerates every slide template the `consulting_pptx` plugin can produce.
...
```python
from consulting_pptx import PresentationBuilder, DEFAULT_THEME
from consulting_pptx.theme import Typography
