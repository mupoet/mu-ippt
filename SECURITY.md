...
We provide security updates for the latest version of mu-ippt.
...
This policy covers the mu-ippt source code in this repository, including:

- Python scripts in `skills/mu-ippt/scripts/`
